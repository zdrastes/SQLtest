    ...
    updatePageAuthUI() {
        ...
        if (mainMessage) {
            if (isAuthenticated) {
                ...
                mainMessage.innerHTML = 'Доступ к заданиям открыт для всех . Задания все одинаковой сложности и уровня знаний. Пожалуйста, включитек демонстрацию экрана перед выбором задания !';
            }
        }
    }
}
